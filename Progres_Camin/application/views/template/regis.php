...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="name" class="form-control" id="exampleInputName1" aria-describedby="nameHelp" placeholder="Masukkan nama">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">NRP</label>
    <input type="nrp" class="form-control" id="exampleInputNRP1" aria-describedby="nrpHelp" placeholder="Masukkan NRP">
  </div>
