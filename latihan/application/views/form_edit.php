...
<body>
    <table>
        <form method="post" action="<?php echo base_url()."index.php/start/update_data"; ?>">
            <tr>
                <td>Nomor Induk</td>
                <td>:</td>
                <td><input type="text" name="ni" disabled placeholder="Masukkan Nomor Induk.." value="<?php echo $no_induk; ?>"></td>
            </tr>
            <tr>
                <td>Nama</td>
                <td>:</td>
